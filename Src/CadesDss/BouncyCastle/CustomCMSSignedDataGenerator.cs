...
internal class CustomCMSSignedDataGenerator : CmsSignedGenerator
{
    ...
    /// <summary>
    /// The ISigner used for the SignerInf
    /// </summary>
    ...
    private class SignerInf
    {
            ...
            SecureRandom random)
        {
            ...
            // CMSSignedDataGenerator CUSTOM CODE
            string signatureName = digestName + "with" + Helper.GetEncryptionAlgName(encOID);
            ISigner sig = outer.signerProvider != null
                ? outer.signerProvider : Helper.GetSignatureInstance(signatureName);
            ...
            outer.digests.Add(digestOID, hash.Clone());
            ...
            if (unsAttr != null)
            {
                ...
                Org.BouncyCastle.Asn1.Cms.AttributeTable unsigned = unsAttr.GetAttributes(baseParameters);
            ...
            AlgorithmIdentifier encAlgId = GetEncAlgorithmIdentifier(
    ...
    */
        ...
        bool encapsulate)
    {
        ...
        if (certs.Count != 0)
        {
            certificates = CmsUtilities.CreateBerSetFromList(certs);
        }
        ...
        if (crls.Count != 0)
        {
            certrevlist = CmsUtilities.CreateBerSetFromList(crls);
        }
